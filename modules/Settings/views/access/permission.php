...
$this->title = Yii::t('settings', 'Правила доступа');
...
<div class="news-index">
    ...
    <p>
        <?= Html::a(Yii::t('settings', 'Добавить новое правило'), ['add-permission'], ['class' => 'btn btn-success']) ?>
    </p>
<?php
