...
$this->title = Yii::t('settings', 'Управление ролями');
...
<div class="news-index">
    ...
    <p>
        <?= Html::a(Yii::t('settings', 'Добавить роль'), ['add-role'], ['class' => 'btn btn-success']) ?>
    </p>
<?php
...
<?=GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'attribute' => 'name',
            'label'     => Yii::t('settings', 'Роль')
        ],
        [
            'class'     => DataColumn::className(),
            'attribute' => 'description',
            'label'     => Yii::t('settings', 'Описание')
        ],
        [
            'class'     => DataColumn::className(),
            'label'     => Yii::t('settings', 'Разрешенные доступы'),
            'format'    => ['html'],
